    ...
    if(isset($_SESSION["shoping_cart"]))
      {
           ...
           if(!in_array($row['pid'], $item_array_id))
           {
                $count = count($_SESSION["shoping_cart"]);
                $item_array = array(
                     'item_id' => $row['pid'],
                     'item_name' => $row['pname'],
                     'item_price' => $row['pcost'],
										 'item_image' => $row['pimg']
                );
			...
			<nav id = "nav">
					...
					<div class="menu">
						...
						<ul id= "ul2">
							...
							<span id="cartcount" style="color: white"></span>
							</li>
							<script src="./js/cart.js"></script><!--Edit extra-->
						</ul>
					</div>
    			    ...
    			    <table class="table table-bordered">
    					...
    					<th width="5%">Action</th>
                          ...
                          <tr>
                               ...
                               <td><a href="cart.php?action=delete&del=<?php echo $values["item_id"]; ?>"><span class="text-danger">Remove</span></a></td>
                          </tr>
                          <?php
