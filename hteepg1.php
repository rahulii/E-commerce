...
<html>
	...
	<body height="100%" width="100%">
		...
		<section>
			<div id="main">
				<div id= "slider">
					<img src="img/hteeslider1.jpg" width="1380px">
				</div>
				<div id="bread">
					<p><a href="men.php">Men</a> &nbsp / &nbsp <a href="menhalfsleeve.php">Half Sleeve T-Shirt's</a></p><!--Edit Here-->
				</div>
				<div id ="submain">
					<div id="sidebar">
					...
					<table>
						<?php
						$query = "SELECT * FROM products WHERE category='Half Sleeves'";
                  ...
                  print "<td>";
					  ...
					  ?>
						<div id="contentbox">
								 <div id="suggest">
									<div id= "ymal">
										<a href="<?php echo 'htee1'.".php?id=".$id?>"> <img src="img/<?php echo $row['pimg'] ?>" height="300px"></a>
			...
			<footer id="foot">
				...
				<div id="fdetail2">
					<div id="fitem2">
						...
						<p>Free Shipping above &nbsp  500</p>
					</div>
					<div id="fitem2">
						<h3>Download The App</h3>
						<a href="https://play.google.com"><img src="img/android.png"></a>
						<a href="https://appstore.com"><img src="img/ios.png"></a>
					</div>
					<div id="fitem2">
